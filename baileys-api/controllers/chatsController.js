import { getSession, getChatList, isExists, sendMessage, sendAudio, formatPhone, getContactList } from './../whatsapp.js'
...
const send = async (req, res) => {
    ...
    try {
        ...
        if(message?.audio?.url){
            await sendAudio(session, receiver, message, 0)
        }
        else
...
export { getList, send, sendBulk, getcontactList }
